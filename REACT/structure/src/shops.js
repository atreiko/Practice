...
export const shops = [
    ...
    },
    {
        ...
        // products: ['Tobacco', 'Coal', 'Mouthpieces', 'Equipment'],
        prod: [
            {
                tabs: ['Tobacco', 'Coal', 'Mouthpieces', 'Equipment'],
                panels: ['Tobacco Panel', 'Coal Panel', 'Mouthpieces Panel', 'Equipment Panel'],
            }
        ] 
    },
    {
